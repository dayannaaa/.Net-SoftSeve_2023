...
internal class Program
{
    ...
    {
        #region  Показати лінію на екран. Символ та довжину лінії повинен вводити користувач.
        ...
        #region Написати гру «Вгадай число». 
        Console.WriteLine("\n\n--------TASK 2---------");
        ...
        #region Створити масив із 20-ти цілих чисел та заповнити його випадковими значеннями від 0 до 100.
        Console.WriteLine("\n\n--------TASK 3---------");
        ...
        #region До попереднього завдання додати меню
        Console.WriteLine("\n\n--------TASK 4---------");
